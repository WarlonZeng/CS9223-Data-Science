...
```{r Q1c, include=TRUE, warning=FALSE}
...
```{r Q2, include=TRUE, warning=FALSE}
df3 <- df
n <- 4
...
```{r Q3a, include=TRUE, warning=FALSE}
...
```{r Q3b, include=TRUE, warning=FALSE}
